...
var auditActionOverrides = map[string]string{
	...
	"PUT /api/v1/admin/content-monitor/config":                "admin.content_monitor.config.update",
	"DELETE /api/v1/admin/content-monitor/events":             "admin.content_monitor.events.delete",
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"PUT /api/v1/admin/content-monitor/config":                  {},
	"DELETE /api/v1/admin/content-monitor/events":               {},
