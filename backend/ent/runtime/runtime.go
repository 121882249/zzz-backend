...
func init() {
	...
	// userDescCreatedIP is the schema descriptor for created_ip field.
	userDescCreatedIP := userFields[7].Descriptor()
	// user.DefaultCreatedIP holds the default value on creation for the created_ip field.
	user.DefaultCreatedIP = userDescCreatedIP.Default.(string)
	// user.CreatedIPValidator is a validator for the "created_ip" field. It is called by the builders before save.
	user.CreatedIPValidator = userDescCreatedIP.Validators[0].(func(string) error)
