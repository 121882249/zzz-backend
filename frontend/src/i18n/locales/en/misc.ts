export default {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 {currency} = {balance} USD balance',
    fixedFee: 'Fixed fee',
    ...
    operationCompleteHint: 'The payment step is complete. Check your order history and balance for the final result.',
    stripePopup: {
