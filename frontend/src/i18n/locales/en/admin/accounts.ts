export default {
    accounts: {
      ...
      responseModelRewrite: 'Rewrite response model name',
      responseModelRewriteEnabled: 'Response model rewrite enabled',
      responseModelRewriteDisabled: 'Response model rewrite disabled',
      responseModelRewriteFailed: 'Failed to toggle response model rewrite',
      dataActions: 'Data',
      toolActions: 'Tools',
      viewColumns: 'Columns',
