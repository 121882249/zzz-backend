export default {
    settings: {
      ...
      payment: {
        ...
        limitsTitle: 'Limits & Pricing',
        limitSingleMin: 'Min per order',
        limitSingleMax: 'Max per order',
        limitDaily: 'Daily limit',
        limitsHint: '0 means unlimited. All limits and pricing belong to this provider.',
        limitsUseGlobal: 'Required',
        limitsNoLimit: 'No limit',
		channelBalanceMultiplier: 'Recharge multiplier',
		channelSubscriptionMultiplier: 'Subscription conversion multiplier',
		channelFeeRate: 'Service fee (%)',
		channelFixedFee: 'Fixed fee',
		channelPricingHint: 'Each USD of plan price is converted by this channel multiplier (for example HKD 7.8, USD 1, or CNY 7.2). The fixed fee also uses the channel currency.',
		validationLimitRange: 'Minimum amount cannot exceed maximum amount',
        productNamePrefix: 'Product Name Prefix',
        productNameSuffix: 'Product Name Suffix',
		productNameSuffixAuto: 'Product suffix (automatic)',
		productNameCurrencyHint: 'Automatically uses this provider\'s payment currency',
		validationProductNamePrefixRequired: 'Product name prefix is required',
        preview: 'Preview',
