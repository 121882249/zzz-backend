export default {
  ...
  keys: {
    ...
    regenerateKey: 'Reset Key',
    regenerateKeyTitle: 'Reset TokenPro Key',
    regenerateKeyConfirmMessage: 'The old key will stop working immediately. Clients using it must be updated. Continue?',
    regenerateKeySuccess: 'A new TokenPro key was generated and the old key is no longer valid',
    failedToRegenerateKey: 'Failed to reset the TokenPro key',
    globalRouting: 'Global routing',
    globalManagedBadge: 'TokenPro automation only',
    globalManagedKey: 'Managed automatically by TokenPro',
    globalManagedKeyHint: 'Do not copy, configure, or use it for direct API calls. Use “Reset Key” for maintenance.',
    id: 'ID',
    apiKey: 'API Key',
    group: 'Group',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      rate: 'Rate',
      cheaperThanOfficial: 'Save {percent}% vs official',
