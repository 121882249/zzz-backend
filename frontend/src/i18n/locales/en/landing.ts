export default {
  ...
  home: {
    ...
    cosmic: {
      ...
      easyAccess: 'One API · Fast integration',
      transparentBilling: 'Transparent billing · Cost control',
      unifiedApi: 'One API',
      multiModel: 'Multi-model access',
      concurrent: 'Stable concurrency',
