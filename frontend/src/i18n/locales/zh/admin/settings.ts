export default {
    settings: {
      ...
      payment: {
        ...
        limitSingleMax: '单笔最高',
        limitDaily: '每日限额',
        limitsHint: '0 表示不限制；限额和计费全部由当前服务商独立决定',
        limitsUseGlobal: '请填写',
        limitsNoLimit: '不限制',
		channelBalanceMultiplier: '充值倍率',
		channelSubscriptionMultiplier: '订阅换算倍率',
		channelFeeRate: '服务费率 (%)',
		channelFixedFee: '固定手续费',
		channelPricingHint: '套餐每 1 USD 按订阅换算倍率收取支付币种（如 HKD 7.8、USD 1、CNY 7.2）；固定手续费也按当前支付币种收取。',
		validationLimitRange: '单笔最低金额不能高于单笔最高金额',
        productNamePrefix: '商品名前缀',
        productNameSuffix: '商品名后缀',
		productNameSuffixAuto: '商品名后缀（自动）',
		productNameCurrencyHint: '自动使用当前服务商的支付币种',
		validationProductNamePrefixRequired: '请填写商品名前缀',
        preview: '预览',
