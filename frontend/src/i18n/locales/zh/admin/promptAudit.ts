export default {
  promptAudit: {
    ...
    policy: {
      ...
      accountMonitor: '单独监控账号', accountMonitorHint: '每行填写一个邮箱。无需 Guard 节点，只记录这些账号后续请求的完整提示词，不扫描、不阻断、不会额外调用模型。', accountMonitorPlaceholder: '每行一个邮箱地址', accountMonitorCount: '正在监控 {count} 个账号',
    },
