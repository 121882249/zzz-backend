export default {
  ...
  version: {
    ...
    upstreamUpdateAvailable: '检测到 Sub2API 底层版本更新：当前 v{current}，最新 v{latest}。请安排合并升级。',
    releaseNotes: '更新日志',
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：1 {currency} = {balance} USD 余额',
    fixedFee: '固定手续费',
    refundReason: '退款原因',
    ...
    operationCompleteHint: '支付操作已结束，到账结果请以订单记录和账户余额为准。',
    stripePopup: {
