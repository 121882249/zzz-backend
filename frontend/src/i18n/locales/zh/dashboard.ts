export default {
  ...
  keys: {
    ...
    regenerateKeyTitle: '重置 TokenPro Key',
    regenerateKeyConfirmMessage: '重置后旧 Key 将立即失效，已配置旧 Key 的客户端需要更新。确定继续吗？',
    regenerateKeySuccess: '新 TokenPro Key 已生成，旧 Key 已失效',
    failedToRegenerateKey: '重置 TokenPro Key 失败',
    globalRouting: '全局路由',
    globalManagedBadge: 'TokenPro 自动调度专用',
    globalManagedKey: '由 TokenPro 自动管理',
    globalManagedKeyHint: '请勿手动复制、配置或用于直连接口；需要维护时请使用“重置 Key”。',
    id: 'ID',
    apiKey: 'API 密钥',
    group: '分组',
  ...
  modelPlaza: {
    ...
    table: {
      ...
      officialPrice: '官方价格',
      rate: '折扣倍率',
      cheaperThanOfficial: '比官方省{percent}%',
